...
| Fenster | SDK Developer | `.squad/agents/fenster/charter.md` | ✅ Active |
| Hockney | SDK Reviewer | `.squad/agents/hockney/charter.md` | ✅ Active |
| Strausz | SDK Architect | `.squad/agents/strausz/charter.md` | ✅ Active |
